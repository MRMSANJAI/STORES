    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100" style={{ marginTop: '-40px' }}>
      <div className="bg-green-500 rounded-full p-4 mb-8">
        <div className="w-60 h-60 flex items-center justify-center rounded-full overflow-hidden">
          <img src="https://img.freepik.com/free-vector/man-browsing-social-media_1308-120816.jpg?w=826&t=st=1704521397~exp=1704521997~hmac=b6dca741c41b784bfa4dd63d23a6be74bd99cf8395a99ce7c00ab18948da768a" alt="Your Image" className="w-full h-full object-cover cursor-pointer"onClick={handleNextPage}/>
        </div>
      </div>
      ...
      <p className="text-center text-size-18 text-sm">
