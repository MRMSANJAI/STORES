...
const items={
   image:"https://activerain.com/image_store/uploads/1/2/3/0/5/ar132661185150321.jpg",
   name:'Bundel Pack',
   price:20,
   weight:25,
   quantity:count
 ...
 return (
        <div className=" mt-2 ml-2 mr-3 ">
            <div class="flex flex-col fixed top-0 w-full z-10 bg-white">
             ...
             <Link to="/popularpacks"class="text-2xl mt-5"><IoArrowBack/></Link> 
            </div>
  ...
  <div className="carousel-item w-full">
   ...
   <div class="flex" >
    ...
    <p class="flex pl-32">
     ...
     <div class='flex mt-2'>
        <CiShoppingCart class ="border-solid border-2 rounded h-10 w-14 mt-2 ml-5" onClick={addToCart}/>
        <button class="ml-16 mt-2 bg-green-500 border-solid  w-52 rounded-lg h-10 text-lg font-medium text-white">Buy Now </button>
     </div>
 </div>
    )
};
