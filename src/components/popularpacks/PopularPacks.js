    ...
    <div>
      <h3 class="pl-6 ml-24 md:pl-50 justify-center text-base font-medium fixed z-40 bg-base-100 w-11/12 ">Popular Packs</h3>
        ...
        <div class="flex flex-wrap" >
         ...
         <div onClick={() => navigate(`/bundledetails/${item.id}`)}>
           <div key={item.id}class="card w-44 h-60 bg-base-100 m-2 shadow-lg border-2 border-solid rounded-lg  px-2 pt-2" >
              <figure>
              ...
              <div class="pl-4 ">
                ...
                <div class="card-actions justify-start">
                  ...
                  <div class=" pt-2 text-lg font-normal line-through"pl-544 > {item.rs} </div>
                </div>
              </div>
            </div>
            </div>
